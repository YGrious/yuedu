...
czgmconfig = [
    {'name': 'xxxx', 'ck': 'xxxx', "uids": 'xxxx','key':'xxxx'},
]
...
'''
czgmconfig = [
    {'name': 'xxx', 'ck': 'o-0fIv9eJPxxxxxxUCNumg', "uids": 'UID_Yxxxxx2Kk','key':'4edaca6803xxxxx05e1'},
...
'''
mtzconfig = [
    {'name': 'xxxx', 'ck': 'share:login:xxxx', "uids": 'xxxx','key':'xxxx'},
...
单账户填写样式(这里只是样式，不要填这里)
xyyconfig = [
    {'name': 'xxx', 'ck': 'xxxx', "uids": 'xxx','key':'xxxx'},
]
多账户填写样式，几个账号填几个，不要多填。(这里只是样式，不要填这里)
xyyconfig = [
    {'name': 'xxxx', 'ck': 'xxxx', "uids": 'xxxx','key':'xxxx'},
...
xkybconfig = [
    ...
    {'name': 'xxxx', 'un': 'oC34qxxxx', 'token': 'xxxx',"uids": 'UID_eYwm1mIxxxx','key':'xxxxx'},
]
#########################################################################
'''
公共推送参数
